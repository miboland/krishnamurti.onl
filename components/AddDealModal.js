        ...
        <ModalContent borderRadius={4}>
          ...
          >
            ...
            <ModalBody pb={6}>
              ...
              <FormControl
                mt={4}
                isInvalid={errors.locationId && errors.locationId.message}
              >
              ...
              <FormControl
                mt={4}
                isInvalid={errors.daysActive && errors.daysActive.message}
              >
                <FormLabel htmlFor="daysActive">Days Active</FormLabel>
                <WeekdayButtonGroup
                  daysActive={daysActive}
                  onChange={setDaysActive}
                />
                <FormErrorMessage>
              ...
              <Flex>
                <FormControl
                  mt={4}
                  mr={4}
                  isInvalid={errors.startTime && errors.startTime.message}
                >
                ...
                <FormControl
                  mt={4}
                  isInvalid={errors.endTime && errors.endTime.message}
                >
